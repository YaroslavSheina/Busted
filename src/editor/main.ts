...
function load(l: LevelData): void {
  delete level.cars; delete level.chaser; delete level.blocks; delete level.branches; delete level.panic; delete level.mix; delete level.intro; delete level.cards; delete level.trap; delete level.checkpoints; delete level.narrows; delete level.rails; delete level.crossings; delete level.props; delete level.oncoming;
